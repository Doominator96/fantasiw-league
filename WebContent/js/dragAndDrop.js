          ...
          (function(t) {
            ...
            function r(e, n) {
              ...
              function E() {
                if (F.dragging) {
                  var e = k || _,
                    n = e.parentElement;
                  n && n.removeChild(e),
                    F.emit(Y.copy ? "cancel" : "remove", e, n),
                    b();
                }
              }
              function x(e) {
                if (F.dragging) {
                  ...
                  var o = O(r);
                  o === !1 && Y.copy === !1 && n && D.insertBefore(t, M),
                    o || n ? F.emit("cancel", t, D) : F.emit("drop", t, r, D),
                    b();
                }
              }
              function b() {
              ...
              function O(e, n) {
                var t;
                return (
                  (t = void 0 !== n ? n : P ? R : f(_ || k)), e === D && t === M
                );
              }
              function T(e, n, t) {
                function r() {
                ...
                if (P) {
                  ...
                  if (u !== D || !Y.copy) {
                    var a,
                      l = k || _,
                      s = B(u, i);
                    if (null !== s) a = L(u, s, n, t);
                    else {
                      if (Y.revertOnSpill !== !0) return;
                      (a = M), (u = D);
                    }
                    (null === a || (a !== l && a !== f(l))) &&
                      ((R = a), u.insertBefore(l, a), F.emit("shadow", l, u));
                  }
                }
              }
              function S() {
              ...
              function C() {
                P &&
                  (s(q, "gu-unselectable"),
                  o(U, "remove", "mousemove", N),
                  P.parentElement.removeChild(P),
                  (P = null));
              }
              function B(e, n) {
                for (var t = n; t !== e && t.parentElement !== e; )
                  t = t.parentElement;
                return t === U ? null : t;
              }
              function L(e, n, t, r) {
                ...
                function i() {
                  ...
                  return u(
                    c ? t > e.left + e.width / 2 : r > e.top + e.height / 2
                  );
                }
                function u(e) {
                  return e ? f(n) : n;
              ...
              var P,
                ...
                X = [],
                Y = n || {};
              void 0 === Y.moves && (Y.moves = a),
                void 0 === Y.accepts && (Y.accepts = a),
            ...
            function o(e, n, r, o) {
              ...
              t.navigator.msPointerEnabled && v[n](e, u[r], o),
                v[n](e, i[r], o),
                v[n](e, r, o);
            }
            function i(e) {
            ...
            function c(e, n, t) {
              ...
              return (
                (o.className += " gu-hide"),
                (r = document.elementFromPoint(n, t)),
                (o.className = i),
                r
              );
            }
            ...
            function d(e, n) {
              return "undefined" == typeof n.targetTouches
                ? n[e]
                : (n.targetTouches &&
        ...
        function(e, n) {
          (function(e) {
            !(function(t, r) {
                ...
                return (
                  ...
                  (e.emitterSnapshot = function(n) {
                    ...
                    return function() {
                      var c = o(arguments),
                        a = this || e;
                      if ("error" === n && t["throws"] !== !1 && !r.length)
                        throw 1 === c.length ? c[0] : c;
                      return (
                        (u[n] = r.filter(function(e) {
              ...
              var c,
                a = "" + r,
                f = "function" == typeof setImmediate;
              (c = f
                ? function(e) {
                    setImmediate(e);
                  }
                : typeof e !== a && e.nextTick
                  ? e.nextTick
                  : function(e) {
                      setTimeout(e, 0);
                    }),
                typeof n !== a && n.exports
                  ? (n.exports = u)
                  : ((t.contra = t.contra || {}), (t.contra.emitter = u));
            })(this);
        ...
        function(e, n) {
          (function(e) {
            ...
            function u(e, n) {
              var t;
              s.createEvent
                ? ((t = s.createEvent("Event")),
                  t.initEvent(n, !0, !0),
                  e.dispatchEvent(t))
                : s.createEventObject &&
                  ((t = s.createEventObject()), e.fireEvent("on" + n, t));
            }
            function c(n, t, r) {
              return function(t) {
                var o = t || e.event;
            ...
            function l(e, n, t) {
              ...
              for (r = 0; r < v.length; r++)
                if (((o = v[r]), o.element === e && o.type === n && o.fn === t))
                  return r;
            }
            var s = document,
              d = t,
              p = o,
              v = [];
            e.addEventListener || ((d = r), (p = i)),
              (n.exports = { add: d, remove: p, fabricate: u });
          }.call(
            this,
            "undefined" != typeof global
              ? global
...
dragula([document.getElementById("gk"), document.getElementById("def"),document.getElementById("mid"),document.getElementById("str"),document.getElementById("rosaG")]);